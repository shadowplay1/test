...
I suggest you to read the [changelog](https://des-docs.js.org/#/docs/main/1.7.1/general/changelog) and the [documentation](https://des-docs.js.org/#/docs/main/1.7.1/general/welcome) to know what's new, what's changed and how to update your code.

Also you can check the [summary](https://des-docs.js.org/#/docs/main/1.7.1/general/updating) to see the main changes in this update.
