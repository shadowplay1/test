...
I suggest you to read the [changelog](./changelog.md) and the [documentation](https://des-docs.tk/#/docs/main/1.6.0/general/welcome) to know what's new, what's changed and how to update your code.
