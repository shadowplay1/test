...
I suggest you to read the [changelog](https://des-docs.js.org/#/docs/main/1.6.6/general/changelog) and the [documentation](https://des-docs.js.org/#/docs/main/1.6.6/general/welcome) to know what's new, what's changed and how to update your code.

Also you can check the [summary](https://des-docs.js.org/#/docs/main/1.6.6/general/updating) to see the main changes in this update.
